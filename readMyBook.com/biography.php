  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="Pictures/bio3.jpg" alt="" width="1002" height="1360"/>
<div class="carousel-caption">
        </div>
	  </div>

      <div class="item">
        <img src="Pictures/bio1.jpg" alt="" width="1000" height="500"/>
        <div class="carousel-caption">
        </div>
	  </div>

      <div class="item">
        <img src="Pictures/bio2.jpg" width="1200" height="330" alt=""/>
		<div class="carousel-caption">
		</div>
	  </div>
...
<div class="container-fluid">
  ...
  <h1>Biography</h1>
	...
	$result = mysqli_query($conn,"SELECT * FROM books WHERE book_genre ='Biography'");
